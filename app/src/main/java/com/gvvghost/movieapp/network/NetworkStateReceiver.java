package com.gvvghost.movieapp.network;
...
public class NetworkStateReceiver extends BroadcastReceiver {
    ...
    private void notifyState(NetworkStateReceiverListener networkStateReceiverListener) {
        ...
        if (connected) networkStateReceiverListener.networkAvailable();
        else networkStateReceiverListener.networkUnavailable();
    }


    public void addListener(NetworkStateReceiverListener networkStateReceiverListener) {
        Log.i(TAG, "addListener() - listeners.add(networkStateReceiverListener)" +
                " + notifyState(networkStateReceiverListener);");
        listeners.add(networkStateReceiverListener);
        notifyState(networkStateReceiverListener);
    }

    public void removeListeners(NetworkStateReceiverListener networkStateReceiverListener) {
